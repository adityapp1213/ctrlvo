...
const AIChatInput: React.FC<AIChatInputProps> = ({ onSend, onAttach }) => {
  ...
  return (
    <div className="w-full flex justify-center items-center text-black" aria-label="AI chat input">
      <motion.div
        ref={wrapperRef}
        className="w-full"
      ...
      >
        <div className="flex flex-col items-stretch w-full h-full">
          <div className="flex items-center gap-2 p-4 rounded-full bg-white w-full">
            <button
          ...
          <motion.div
            ...
            variants={{
              hidden: { opacity: 0, y: 20, pointerEvents: "none", transition: { duration: 0.25 } },
              visible: { opacity: 1, y: 0, pointerEvents: "auto", transition: { duration: 0.35, delay: 0.08 } },
            }}
            initial="hidden"
