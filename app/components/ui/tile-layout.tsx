...
function useSafeLocalParticipant() {
  try {
...
export function useLocalTrackRef(source: Track.Source) {
  const { localParticipant } = useSafeLocalParticipant();
...
function useSafeTracks(sources: Track.Source[]) {
  try {
    return useTracks(sources);
  } catch {
    return [] as unknown as ReturnType<typeof useTracks>;
  }
}
...
function useSafeVoiceAssistant() {
  try {
    ...
    } as ReturnType<typeof useVoiceAssistant>;
  }
}
...
export function TileLayout({ chatOpen }: TileLayoutProps) {
  ...
  } = useSafeVoiceAssistant();
  const [screenShareTrack] = useSafeTracks([Track.Source.ScreenShare]);
              ...
              {((cameraTrack && isCameraEnabled) || (screenShareTrack && isScreenShareEnabled)) && (
                ...
                >
                  <VideoTrack
                    ...
                    trackRef={(cameraTrack || screenShareTrack) as any}
